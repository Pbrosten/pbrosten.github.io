;(function(exports) {
    ...
    var calendarGenerators = {
        ...
        // Yahoo generator removed: it re-shifted the start by the *viewer's* getTimezoneOffset(),
        // which gave the wrong hour to every guest outside Barcelona once the event dates became
        // absolute instants (js/scripts.js, ISO 8601 with +02:00).
